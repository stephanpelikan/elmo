...
public class OAuth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(
        ...
        if (member.isEmpty()) {
            return new ElmoOAuth2User(provider, oauth2Id, null, user.getAuthorities(), user.getAttributes());
        }
        ...
        return new ElmoOAuth2User(provider, oauth2Id, elmoId, authorities, user.getAttributes());
